 ...
 * (so no rejoin can revive it — see joinRoom/joinRoomAsRecruiter's ENDED guard), marks the
 * schedule COMPLETED, and generates the AI judgment best-effort (a judgment failure must never
 * block the end action itself).
 */
