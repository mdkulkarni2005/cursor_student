...
const STATUS_LABEL: Record<string, string> = { READY: "Ready", DRAFT: "Draft" };
    ...
    <View style={styles.screen}>
      <Stack.Screen
        options={{
          title: "Projects",
          headerRight: () => (
            <Pressable onPress={() => router.push("/projects/ideas")}>
              <Text style={styles.newLink}>New idea</Text>
            </Pressable>
          ),
        }}
      />
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.intro}>
            ...
            <Text style={styles.subtitle}>Ideas, a full build plan, and a report + PPT + viva bundle — end to end.</Text>
          </View>
        }
        ListEmptyComponent={
          loading ? (
            ...
            <View style={styles.emptyState}>
              <Text style={styles.empty}>No projects yet — tap New idea to start.</Text>
            </View>
          )
        }
        renderItem={({ item }) => {
            ...
            <Pressable onPress={() => router.push(`/projects/${item.id}`)}>
              <Card style={styles.row}>
                <View style={styles.rowIconBadge}>
                  <StarIcon size={16} color={colors.primaryDeep} />
                </View>
