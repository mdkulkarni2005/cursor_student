    ...
    <View style={styles.screen}>
      <Stack.Screen
        options={{
          title: "Reports",
          headerRight: () => (
            <Pressable onPress={() => router.push("/reports/new")}>
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.intro}>
            ...
            <Text style={styles.subtitle}>Generate polished, college-format reports — seminar, mini-project, internship and more.</Text>
          </View>
        }
        ListEmptyComponent={
          loading ? (
            ...
            <View style={styles.emptyState}>
              <Text style={styles.empty}>Your generated reports will appear here — tap New to create one.</Text>
            </View>
          )
        }
        renderItem={({ item }) => {
            ...
            <Pressable onPress={() => router.push(`/reports/${item.id}`)}>
              <Card style={styles.row}>
                <View style={styles.rowIconBadge}>
                  <SlidesIcon size={16} color={colors.teal} />
                </View>
