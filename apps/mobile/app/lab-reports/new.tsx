...
export default function NewLabReport() {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: "#fff" }} contentContainerStyle={{ padding: 20 }}>
      ...
      <Text style={styles.label}>Or type your raw readings</Text>
      <TextInput style={[styles.input, { height: 80 }]} value={readingsText} onChangeText={setReadingsText} multiline />
