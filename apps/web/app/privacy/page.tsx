...
export const metadata = { title: "Privacy Policy — StudentOS" };

export default function PrivacyPage() {
  return (
    <LegalShell title="Privacy Policy" updated="June 2026">
      <p>
        StudentOS (&ldquo;we&rdquo;, &ldquo;the app&rdquo;) helps students generate academic work and prepare for
