    ...
    <div className="flex h-full flex-col border-t border-line">
      ...
      <form action={submitAction} className="border-t border-line p-3">
        ...
        <button
          ...
          className="w-full rounded-xl bg-accent-gradient py-2.5 text-[13.5px] font-semibold text-on-accent shadow-[0_6px_18px_rgba(254,127,45,0.3)] transition-transform hover:-translate-y-0.5 disabled:opacity-60"
        >
