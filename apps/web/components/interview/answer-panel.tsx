    ...
    <div>
      ...
      <form action={submitAnswerAction} className="rounded-2xl border border-line bg-card p-4">
        ...
        <SubmitButton
          ...
          className="mt-3 w-full rounded-xl bg-accent-gradient py-2.5 text-[13.5px] font-semibold text-on-accent shadow-[0_6px_18px_rgba(246,146,30,0.3)] transition-transform hover:-translate-y-0.5 disabled:opacity-60"
        >
