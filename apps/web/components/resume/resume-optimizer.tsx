              ...
              {keywords.length > 0 ? (
                <div className="rounded-xl border border-line p-3">
                  ...
                  <button
                    ...
                    className="mt-2 rounded-lg bg-accent-gradient px-3 py-1.5 text-[12px] font-semibold text-on-accent shadow-[0_4px_14px_rgba(254,127,45,0.3)] disabled:opacity-60"
                  >
