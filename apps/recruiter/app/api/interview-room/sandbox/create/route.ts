...
import { createSandboxForRecruiter } from "@/lib/live-interview";

/** Recruiter's "Launch Code" button — creates (or resumes) the shared coding sandbox. */
export async function POST(req: Request) {
  ...
  try {
    const result = await createSandboxForRecruiter(scheduleId, guard.recruiter.id);
