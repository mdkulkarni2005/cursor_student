...
const DISMISS_KEY = "studentos:recruiter-install-prompt-dismissed";

/** Captures the browser's install prompt once and keeps it for re-use (Chrome only fires
 *  beforeinstallprompt once per load). */
...
if (typeof window !== "undefined") {
  ...
  // a manifest + icons alone are not enough.
...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 z-50 w-[calc(100%-2rem)] max-w-[380px] -translate-x-1/2 rounded-2xl border border-line-strong bg-card p-4 shadow-[0_12px_28px_rgba(15,23,42,0.12)]">
      <p className="text-[13.5px] font-semibold text-ink">Install Vidyas OS Recruiter</p>
