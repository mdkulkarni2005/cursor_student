...
export default async function FeedbackPage() {
  ...
  return (
    <AdminShell>
      <div className="mb-5">
        <h1 className="font-display text-[24px] font-bold text-ink">Feedback</h1>
      ...
      {feedback.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-line bg-card p-10 text-center text-[13px] text-faint">
          No feedback yet.
        </div>
      ) : (
