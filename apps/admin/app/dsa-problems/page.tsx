...
export default async function DsaProblemsPage() {
  ...
  return (
    <AdminShell>
      <div className="mb-5">
        <h1 className="font-display text-[24px] font-bold text-ink">DSA problems</h1>
        <p className="mt-1 text-[13px] text-muted">
          {attempts} total attempts across {byProblem.length} problems. The catalog itself is code
          (<code className="rounded bg-surface px-1 py-0.5 text-[11.5px]">apps/web/lib/dsa/catalog</code>),
          authored via the <code className="rounded bg-surface px-1 py-0.5 text-[11.5px]">scripts/dsa-verify</code>{" "}
