...
export function AccountOps({
  ...
  return (
    <div className="rounded-2xl border border-line bg-card p-4">
      <p className="mb-3 text-[11px] font-semibold uppercase tracking-wide text-faint">Account operations</p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {confirmDelete && (
          <button
            ...
            className="text-[12px] font-medium text-faint hover:text-soft"
          >
            cancel
          </button>
        )}
      ...
      <p className="mt-2 text-[11px] text-faint">All actions here are recorded in the audit log.</p>
    </div>
  );
}
