        ...
        <td className="px-3 py-2.5" colSpan={4}>
          <form action={onSave} className="flex flex-wrap items-center gap-2">
            <input
              ...
              defaultValue={name}
              required
              className="rounded-lg border border-line bg-input px-2.5 py-1.5 text-[14.5px] text-ink"
            />
            <input
              name="university"
            ...
            <button
              type="submit"
              disabled={isPending}
              className="rounded-lg bg-cyan px-2.5 py-1.5 text-[13.5px] font-semibold text-on-accent"
            >
              Save
            </button>
            <button
              ...
              className="text-[13.5px] font-medium text-faint hover:text-soft"
            >
              Cancel
            </button>
