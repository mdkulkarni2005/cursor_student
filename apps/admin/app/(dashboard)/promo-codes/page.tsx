...
export default async function PromoCodesPage() {
  ...
  return (
    <>
      <div className="mb-5">
        <h1 className="font-display text-[26px] font-bold text-ink">Promo codes</h1>
      ...
      <form action={createPromoCode} className="mb-6 grid gap-2 rounded-2xl border border-line bg-card p-4 sm:grid-cols-3 lg:grid-cols-6">
        <input
          ...
          required
          className="rounded-lg border border-line bg-input px-2.5 py-2 text-[15px] uppercase text-ink placeholder:text-faint placeholder:normal-case"
        />
        <select name="discountType" required className="rounded-lg border border-line bg-input px-2.5 py-2 text-[15px] text-ink">
        ...
        <input
          ...
          placeholder="Value"
          required
          className="rounded-lg border border-line bg-input px-2.5 py-2 text-[15px] text-ink placeholder:text-faint"
        />
        <select name="planTierId" className="rounded-lg border border-line bg-input px-2.5 py-2 text-[15px] text-ink">
        ...
        <div className="flex items-center gap-2">
          <input type="date" name="expiresAt" className="w-full rounded-lg border border-line bg-input px-2 py-2 text-[14.5px] text-ink" />
          <button type="submit" className="shrink-0 rounded-lg bg-cyan px-3 py-2 text-[14.5px] font-semibold text-on-accent hover:opacity-90">
            Create
          </button>
        </div>
      </form>
