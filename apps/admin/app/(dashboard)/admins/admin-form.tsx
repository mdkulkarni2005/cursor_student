  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-line bg-card p-4">
        <p className="mb-3 text-[13px] font-semibold uppercase tracking-wide text-faint">Grant admin access</p>
        <div className="flex flex-wrap items-center gap-2">
          <input
            ...
            className="min-w-[220px] flex-1 rounded-lg border border-line bg-surface px-3 py-1.5 text-[15px] text-ink"
          />
          <select
            value={role}
      ...
      <div className="rounded-2xl border border-line bg-card p-4">
        <p className="mb-3 text-[13px] font-semibold uppercase tracking-wide text-faint">Current admins ({admins.length})</p>
        {admins.length === 0 ? (
          <p className="text-[15px] text-faint">No admins found.</p>
        ) : (
            ...
            {admins.map((a) => (
              <li key={a.clerkId} className="flex items-center justify-between gap-3 border-b border-line/60 pb-2 last:border-0 last:pb-0">
                <div>
                  ...
                  <p className="text-[13px] text-faint">{a.email}</p>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-danger/40 px-2.5 py-1 text-[13.5px] font-semibold text-danger transition hover:bg-danger/10 disabled:opacity-50"
                  >
