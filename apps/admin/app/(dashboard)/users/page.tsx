      ...
      <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
        ...
        <form className="flex flex-wrap items-center gap-2">
          <input
            ...
            className="w-[240px] rounded-lg border border-line bg-input px-3 py-2 text-[15px] text-ink placeholder:text-faint focus:outline-none focus:ring-2 focus:ring-cyan/30"
          />
          <select
            name="plan"
            defaultValue={plan}
            className="rounded-lg border border-line bg-input px-2.5 py-2 text-[15px] text-ink focus:outline-none focus:ring-2 focus:ring-cyan/30"
          >
          ...
          <button
            type="submit"
            className="rounded-lg bg-cyan px-3 py-2 text-[14.5px] font-semibold text-on-accent hover:opacity-90"
          >
            Filter
          </button>
          {hasFilters && (
            <Link href="/users" className="text-[14px] font-medium text-faint hover:text-soft">
              Clear
            </Link>
          )}
        </form>
