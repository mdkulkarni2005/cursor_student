...
export function SessionLimitControl({ initial }: { initial: number }) {
  ...
  return (
    <div className="rounded-2xl border border-line bg-card p-4">
      <p className="mb-1 text-[11px] font-semibold uppercase tracking-wide text-faint">Max concurrent sessions</p>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-20 rounded-lg border border-line bg-surface px-2 py-1.5 text-[13px] text-ink"
        />
        <button
          type="button"
          disabled={isPending}
