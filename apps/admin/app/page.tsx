    ...
    <AdminShell>
      ...
      <div className="mb-8 grid gap-4 lg:grid-cols-3">
        <div className="rounded-2xl border border-line bg-card p-4">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-wide text-faint">Active users</p>
        ...
        <div className="rounded-2xl border border-line bg-card p-4">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-wide text-faint">Plan distribution</p>
          <div className="space-y-2">
            {(["FREE", "PRO", "PREMIUM"] as const).map((p) => {
              ...
              return (
                <div key={p}>
                  <div className="mb-0.5 flex justify-between text-[12px]"><span className="text-soft">{p}</span><span className="text-faint">{count} ({pct}%)</span></div>
        ...
        <div className="rounded-2xl border border-line bg-card p-4">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-wide text-faint">DSA engagement</p>
          <dl className="space-y-2 text-[13px]">
      ...
      <div className="mb-8 rounded-2xl border border-line bg-card p-4">
        <p className="mb-3 text-[11px] font-semibold uppercase tracking-wide text-faint">Usage by kind — last 28 days</p>
        <div className="space-y-2">
          {(["ASSIGNMENT", "REPORT", "PPT"] as const).map((k) => {
            ...
            return (
              <div key={k}>
                <div className="mb-0.5 flex justify-between text-[12px]"><span className="text-soft">{KIND_LABEL[k]}</span><span className="text-faint">{count}</span></div>
                <div className="h-1.5 w-full overflow-hidden rounded-full bg-surface">
