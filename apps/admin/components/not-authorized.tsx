  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-canvas px-6">
      <div className="max-w-[380px] rounded-2xl border border-line bg-card p-6 text-center">
        <p className="font-display text-[20px] font-bold text-ink">Not authorized</p>
        ...
        {reason !== "signed-out" && (
          <div className="mt-4">
            <SignOutButtonPlain className="rounded-lg border border-line px-3 py-1.5 text-[14.5px] font-medium text-soft hover:bg-surface">
              Sign out
            </SignOutButtonPlain>
          </div>
        )}
